  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="min-h-screen p-10 bg-[#d1a601] text-black">
        ...
        <motion.div className=" mt-10 grid grid-cols-1 md:grid-cols-3 gap-10 px-10 md:px-20"
        ...
        >
          ...
          <div className="bg-white rounded-2xl min-h-96 p-8 text-center shadow-md">
            <div>
              <img src={ClientAtention} alt="AtencionCliente" className="w-60- h-60 mx-auto"/>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 text-center shadow-md">
            <div>
              <img src={WhatsApp} alt="WhatsappLogo" className="w-60- h-60 mx-auto"/>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 text-center shadow-md">
            <div>
              <img src={Mail} alt="Mail" className="w-60- h-60 mx-auto"/>
            </div>
